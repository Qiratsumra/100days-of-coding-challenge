...
It should take the user's name as a parameter and say hello. If no name is given, it should greet an anonymous user.
...
function userGteet(userName) {
    if (userName === void 0) { userName = "qirat"; }
    console.log("hey ".concat(userName));
}
;
userGteet("Saeed");
userGteet();
