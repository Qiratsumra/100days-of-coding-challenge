...
function calculateRectangle(rectangleLength:number, rectangleWidth) {
...
let  calculateRectangleArrow = (rectangleLength:number, rectangleWidth) => rectangleLength * rectangleWidth;
