...
var middle = Math.floor(guests.length / 2);
...
guests.forEach(function (guest) { return console.log("".concat(guest, " is inviting for grand dinner")); });
